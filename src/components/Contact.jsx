        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:items-start">
          <div className="flex flex-col gap-4 sm:gap-6 animate-fade-in h-full">
            <div className="glass-effect rounded-2xl p-4 sm:p-6 hover:shadow-neon hover:scale-105 hover:-translate-y-1 transition-all duration-300 flex-1">
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-accent">Contact Information</h3>
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center gap-3">
                  <span className="text-sm sm:text-base font-semibold text-neon min-w-[60px]">Email:</span>
                  <a href="mailto:abirchodha1@gmail.com" className="text-sm sm:text-base hover:text-neon transition-colors break-all">
                    abirchodha1@gmail.com
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm sm:text-base font-semibold text-neon min-w-[60px]">Phone:</span>
                  <a href="tel:+919661384853" className="text-sm sm:text-base hover:text-neon transition-colors">
                    +91 96613 84853
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-sm sm:text-base font-semibold text-neon min-w-[60px]">Location:</span>
            ...
            <div className="glass-effect rounded-2xl p-4 sm:p-6 hover:shadow-neon hover:scale-105 hover:-translate-y-1 transition-all duration-300">
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-accent">Connect With Me</h3>
              <div className="flex gap-3 sm:gap-4 flex-wrap">
                <a 
                  href="https://www.linkedin.com/in/abir-chodha/" 
                  target="_blank" 
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6 glass-effect rounded-2xl p-6 sm:p-8 hover:shadow-neon hover:scale-105 hover:-translate-y-1 transition-all duration-300 animate-fade-in h-full flex flex-col">
            <div>
