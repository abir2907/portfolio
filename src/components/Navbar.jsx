  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 backdrop-blur-md ${
        scrolled
          ? "bg-secondary/80 shadow-lg shadow-accent/10 border-b border-accent/20"
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-4 sm:px-6 md:px-8">
        <a
          href="#home"
          className="font-bold text-xl sm:text-2xl tracking-wider text-accent hover:text-neon transition-all duration-300 transform hover:scale-110"
        >
          Abir Chodha
        </a>
        ...
        <nav className="hidden md:flex gap-6 lg:gap-8 text-sm font-medium uppercase tracking-wide">
          <a
            href="#home"
            className="relative text-text hover:text-accent transition-all duration-300 group"
          >
            Home
        ...
        <div className="md:hidden glass-effect border-t border-border">
          <nav className="flex flex-col px-4 py-4 space-y-3">
            <a
              ...
              className="text-text hover:text-accent transition-all duration-300 py-2"
            >
              Home
            </a>
            <a
