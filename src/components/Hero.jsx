...
const Hero = () => (
  <section
    id="home"
    className="relative flex flex-col md:flex-row items-center justify-center min-h-screen gap-8 sm:gap-12 pt-24 sm:pt-28 md:pt-32 pb-12 px-4 md:px-8 overflow-hidden"
  >
    ...
    <div className="max-w-2xl text-center md:text-left space-y-4 sm:space-y-6">
      ...
      <p className="text-sm sm:text-base md:text-lg text-text/90 leading-relaxed animate-fade-in-up animation-delay-400">
        Computer Science Engineering student at VIT-AP University with expertise
        in MERN/PERN stack development. Built 3+ production-ready full-stack
        applications including an AI-powered SaaS platform and secure job
        portal. Proficient in PostgreSQL/MongoDB schema design, JWT
        authentication, RESTful API development, and cloud integrations.
      </p>
